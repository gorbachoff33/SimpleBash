...
for var in -v -n -h -c -l -s -i
do
  for var2 in -v -n -h -c -l -s -i
  do
      for var3 in -v -n -h -c -l -s -i
      do
        if [ $var != $var2 ] && [ $var2 != $var3 ] && [ $var != $var3 ]
        then
          TEST1="for s21_grep.c s21_grep.c Makefile $var $var2 $var3"
          echo "$TEST1"
          ...
          TEST3="-e for -e ^int s21_grep.c s21_grep.c Makefile $var $var2 $var3"
          echo "$TEST3"
